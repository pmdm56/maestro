...
def find_function_def(nf, nf2, impl, fname):
	...
	src_files = get_original_nf_srcs(nf) + get_original_nf_srcs(nf2)
...
def build(boilerplate, impl, nf1, nf2):
	...
	while not success:
		...
		extra_code = find_missing_code(nf1, nf2, impl, makefile_report)
...
if __name__ == "__main__":
	...
	parser.add_argument('nf1', type=str, help='path to the original NF 1')
